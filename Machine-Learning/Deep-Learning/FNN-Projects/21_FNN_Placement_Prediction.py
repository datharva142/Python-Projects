...
try:
    ...
    print("Error: Dataset file not found. Please check the path and try again.")
    exit(1)
...
joblib.dump(model, "Preserved-models/placement_fnn_model.pkl")
joblib.dump(scaler, "Preserved-models/placement_scaler.pkl")
...
loaded_model = joblib.load("Preserved-models/placement_fnn_model.pkl")
loaded_scaler = joblib.load("Preserved-models/placement_scaler.pkl")
