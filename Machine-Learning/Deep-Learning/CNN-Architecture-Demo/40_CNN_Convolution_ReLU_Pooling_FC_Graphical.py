...
# ------------------------------------------------------------
def ShowConvolutionStep(image, kernel, start_row, start_col, current_output=None, step_title=""):
...
# ------------------------------------------------------------
def Convolution_Animated(image, kernel, delay=1.5):
...
# ------------------------------------------------------------
def ShowPoolingStep(feature_map, start_row, start_col, current_output=None, step_title=""):
...
# ------------------------------------------------------------
def Pooling_Animated(data, delay=1.5):
...
# ------------------------------------------------------------
def ShowPipeline(image, conv, relu, pool):
...
def CNN_Animated():
    ...
    conv = Convolution_Animated(image, kernel, delay=1.0)
    Display(conv, "Final Convolution Output")

    relu = ReLU(conv)
    Display(relu, "ReLU Output")

    pool = Pooling_Animated(relu, delay=1.0)
    Display(pool, "Final Pooling Output")
    ...
    ShowPipeline(image, conv, relu, pool)
