...
try:
    ...
    if physical_devices:
        ...
        print("GPU detected and configured for memory growth.")
    else:
...
try:
    ORIGINAL_DATASET = "Dataset/CrackDataset"
except Exception as e:
    print("Error initializing dataset path:", e)
    exit()
...
checkpoint = ModelCheckpoint(
    "Models/Best_Crack_Detection_Model.keras",
...
model.save("Models/Final_Crack_Detection_Model.keras")
