...
st.markdown(
    '<div class="main-title">Intelligent Document Question Answering System</div>',
    unsafe_allow_html=True
)
...
<b>Author:</b> Atharva Deshmukh<br><br>
...
<div class="footer">
<hr>
Project developed by Atharva Deshmukh | Date: 09/05/2026
</div>
""", unsafe_allow_html=True)